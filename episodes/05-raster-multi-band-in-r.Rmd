...
as you have to stretch and often downsample large images, as `geom_spatraster()`
does natively. You also have to specify an RGB color mappig for the raster 
itself with the `RGB()` function.
